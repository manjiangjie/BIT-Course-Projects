 ...
 <nav class="navbar  navbar-fixed-top navbar-inverse " role="navigation">
  <div class="container">
   <div class="navbar-header">
    ...
    <a class="navbar-brand" href="#"><img class="navimg1" alt="Brand" src="/apply/Public/image/站内信2/u42.png"></a>
    ...
    <ul class="nav navbar-nav ">
      ...
      <li><a href="海归路上.html">海归路上</a></li>
           ...
           <ul class="nav navbar-nav navbar-right">
            <li class="active"><a href="站内信.html"><img class="navimg2" alt="Brand" src="/apply/Public/image/站内信2/1_u297.png"></a></li>
            <li><a href="个人界面首页.thm"><img class="navimg2" alt="Brand" src="/apply/Public/image/站内信2/2_u299.png"></a></li>
            <li><a href="#">加入收藏</a></li>
          </ul>
