    ...
    <ul class="nav navbar-nav ">
      ...
      <li><a href="#">海归路上</a></li>
           ...
           <ul class="nav navbar-nav navbar-right">
            ...
            <li class="active"><a href="<?php echo U('WebShow/indi_personalfront');?>"><img class="navimg2" alt="Brand" src="/apply/Public/image/个人界面首页/2_u299.png"></a></li>
            <li ><a href="#">加入收藏</a></li>
          </ul>
    ...
    <div class="recommend">
      ...
      <div class="table-responsive">
        <table class="table table-striped table-hover">
          ...
          <?php if(is_array($jobList)): foreach($jobList as $key=>$item): ?><tr>
              <td>
                <p><?php echo ($item["jobname"]); ?></p>
                <p><?php echo ($item["companyname"]); ?></p>
              </td>
              <td><?php echo ($item["jobaddress"]); ?></td>
              <td><?php echo ($item["createtime"]); ?></td>
              <td>月薪<?php echo ($item["jobsalary"]); ?></td>
