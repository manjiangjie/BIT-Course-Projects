      ...
      <ul class="nav navbar-nav ">
        ...
        <div class="container" id="jobtab">
          ...
          <div class="tab-content">
            ...
            <div role="tabpanel" class="tab-pane fade in <?php echo ($isactive["deliver"]); ?>" id="deliver">
             <div class="table-responsive">
               ...
               <div class="panel panel-default">
                 ...
                 <table class="table table-striped table-hover">
                  ...
                  <?php if(is_array($list1)): foreach($list1 as $key=>$z): ?><tr>
                    <td>
                      <p><?php echo ($z["jobname"]); ?></p>
                      <p><?php echo ($z["companyname"]); ?>|<?php echo ($z["companyaddress"]); ?></p>
                      <p><?php echo ($z["jobindustry"]); ?></p>
                    </td>
                    <td><?php echo ($z["interviewdelivertime"]); ?></td>
                    <td> 
                      <p>面试邀约</p>
                    </td>
          ...
          <div role="tabpanel" class="tab-pane fade in <?php echo ($isactive["collect"]); ?>" id="favorites">
            <div class="table-responsive">
              <div class="panel panel-default">
               <div class="panel-body">
                 <div class="form-group">
               ...
               <table class="table table-striped table-hover">
                ...
                <?php if(is_array($list2)): foreach($list2 as $key=>$z): ?><tr>
                  <td><?php echo ($z["jobname"]); ?></td>
                  <td><?php echo ($z["companyname"]); ?></td>
                  <td><?php echo ($z["jobindustry"]); ?></td>
                  <td><?php echo ($z["companyaddress"]); ?></td>
                  <td><?php echo ($z["createtime"]); ?></td>
                  <td><?php echo ($z["jobstatus"]); ?></td>
                </tr><?php endforeach; endif; ?>
              </table>
              <?php echo ($page2); ?>
            </div> <!-- panel -->  
