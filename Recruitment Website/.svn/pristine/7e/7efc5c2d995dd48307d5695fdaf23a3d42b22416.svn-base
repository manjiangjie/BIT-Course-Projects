...
<div class="container" id="search">
	<div class="content">
        ...
        <div class="right">
   	  		<div class="block" id="block-title">简历收藏</div>
            <form>
            	<div class="block">
                    <br>
                ...
                <div class="block">
                    ...
                    <br>
                    <?php if(is_array($collectedResumeInfo)): foreach($collectedResumeInfo as $key=>$r): ?><div class="resume">
                    	<ul>
