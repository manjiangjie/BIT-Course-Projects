...
<div class="container">
	<div class="content">
        ...
        <div class="right">
   	  		<div class="block" id="block-title">已失效职位</div>
            <form>
            	<div class="block">
                    <br>
                    <label class="lab-title">时间：</label>
              		<select id="select-year">
                    	<option>2015</option>
                    </select> 年
                    <select id="select-month"></select> 月
                    <select id="select-day"></select> 日
                   ——
                    	<select id="select-year">
                    	<option>2015</option>
                    </select> 年
                ...
                <div class="block">
                    ...
                    <span class="pos-des">重新发布</span>
                    <br><br>
                    <?php if(is_array($failedJobInfo)): foreach($failedJobInfo as $key=>$a): ?><div class="position">
                    	<input type="checkbox">
              			<div class="info-pos">
                        	<div class="pos-name"><?php echo ($a["jobname"]); ?></div>
                            <div class="pos-intro">地点：<?php echo ($a["jobaddress"]); ?> | 薪水：<?php echo ($a["jobsalary"]); ?>/月 | 招聘人数：<?php echo ($a["jobrecruitnum"]); ?> | 已收到简历 <?php echo (jobgetresumenum($a["jobid"])); ?> 份 | 失效时间：</div>
                        </div>
                        <div  class="end-post">
                          <label>重新发布</label></div>
