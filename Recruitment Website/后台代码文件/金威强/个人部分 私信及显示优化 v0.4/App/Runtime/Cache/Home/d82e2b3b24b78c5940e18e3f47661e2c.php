 ...
 <nav class="navbar  navbar-fixed-top navbar-inverse " role="navigation">
  <div class="container">
   <div class="navbar-header">
    ...
    <a class="navbar-brand" href="<?php echo U('WebShow/indi_Home');?>"><img class="navimg1" alt="Brand" src="/apply/Public/image/站内信/u42.png"></a>
    ...
    <ul class="nav navbar-nav ">
      ...
      <li><a href="#">海归路上</a></li>
           ...
           <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="<?php echo U('WebShow/indi_personalfront');?>"><img class="navimg2" alt="Brand" src="/apply/Public/image/站内信/2_u299.png"></a></li>
            <li><a href="#">加入收藏</a></li>
          </ul>
    ...
    <div class="container" id="sixin-all"> 
      ...
      <div class="row">
        ...
        <div class="sixin-write">
          <a href="<?php echo U('WebShow/indi_webNews_show_detail');?>"><button type="button"  class="btn btn-primary col-md-6">写私信</button></a>
        </div>
      </div><!-- ./row-->
      <hr>
         ...
         <ul class="sixin-ul">
          <div class="row">  
            ...
            <li class="col-md-8 sixin-1">
              ...
              <div  class="sixin-towho"><a>
              <?php
 if($item['messagefromid']==$_SESSION['indiId']){ echo htmlentities("我"); } else { $temp=$item['name']; echo htmlentities("$temp"); } ?></a> 发送给 <a><?php
 if($item['messagetoid']==$_SESSION['indiId']){ echo htmlentities("我"); } else { $temp=$item['name']; echo htmlentities("$temp"); } ?></a>：</div>
              ...
              <div class="row">      
                ...
                <div class="col-md-5">
                 <a  href="<?php echo U('WebShow/indi_webNews_show_detail',array('id1'=>$item['messagefromid'],'id2'=>$item['messagetoid']));?>">共<?php echo ($item["number"]); ?>条对话</a>
                 <span>|</span>
