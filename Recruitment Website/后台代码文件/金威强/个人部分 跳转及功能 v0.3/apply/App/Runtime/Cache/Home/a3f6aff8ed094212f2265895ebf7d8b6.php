...
<link rel="stylesheet" type="text/css" href="/apply/Public/css/zmqy.css">
 ...
 <nav class="navbar  navbar-fixed-top navbar-inverse " role="navigation">
  <div class="container">
   <div class="navbar-header">
    ...
    <a class="navbar-brand" href="<?php echo U('WebShow/indi_Home');?>"><img class="navimg1" alt="Brand" src="/apply/Public/image/知名企业/u42.png"></a>
        ...
        <li><a href="<?php echo U('WebShow/indi_Home');?>">首页 <span class="sr-only">(current)</span></a></li>
         ...
         <li class="dropdown">
          ...
          <ul class="dropdown-menu" role="menu">
            ...
            <li class="active"><a href="<?php echo U('WebShow/indi_famous');?>">知名企业</a></li>
              <li><a href="#">视频面试</a></li>
                <li><a href="#">海归路上</a></li>
     
      </ul>
     <ul class="nav navbar-nav navbar-right">
          <li><a href="<?php echo U('WebShow/indi_webNews_show_all');?>"><img class="navimg2" alt="Brand" src="/apply/Public/image/知名企业/1_u297.png"></a></li>
          <li><a href="<?php echo U('WebShow/indi_personalfront');?>"><img class="navimg2" alt="Brand" src="/apply/Public/image/知名企业/2_u299.png"></a></li>
          <li><a href="#">加入收藏</a></li>
      </ul>
...
<!--头部图片显示-->
<img src="/apply/Public/image/知名企业/u278.png" id="img2"/>
<!--搜索模块-->
<div class="container" id="qiye-search">
  <div class="row">
  
 <div class="form-group">
     <div class="col-md-3">
     </div>
    <label for="行业" class="col-md-1 control-label lable-hangye">行业</label>
   <div class="col-md-2">
   <div class="input-group">
    ...
    <label for="职能" class="col-md-1 control-label lable-hangye">选择地区</label>
   <div class="col-md-1">
  ...
  <option></option>
     ...
     <option>深圳</option>
      <option>海外</option>
       ...
       <div class="col-md-2">
          <input type="text" class="form-control" name="keywords" placeholder="请输入公司全称或关键词"/>
           </div>
...
<div class="main">
    <div class="container">
     <div class="title">国内名企</div>
      <div clss="row">
       <!--一个企业模块-->
       
        <div class="col-sm-6 col-md-3 ">
         <div class="modul panel panel-default">
          <div><!--企业logo-->
          <a href="#"><img src="/apply/Public/image/知名企业/u272.png" class="img3"/></a></div>
          <!--文字内容-->
          <div class="table">
            <table class="table">
            <tr>
  ...
  <div class="container">
  <div class="title">聘用热门企业</div>
   <div clss="row">
      <!--一个企业模块-->
       <div class="col-sm-6 col-md-3 ">
         <div class="modul panel panel-default">
         <div><!--企业logo-->    
          <a href="#"><img src="/apply/Public/image/知名企业/u214.jpg" class="img3"/></a></div>
          <!--文字内容--> 
          <div class="table">
            <table class="table">
            <tr>
  ...
  <div class="container">
  <div class="title">创业新秀</div>
   <div clss="row">
      <!--一个企业模块-->
        <div class="col-sm-6 col-md-3 ">
         <div class="modul panel panel-default">
          <div><!--企业logo-->
          <a href="#"><img src="/apply/Public/image/知名企业/u216.jpg" class="img3"/></a></div>
          <!--文字内容-->
          <div class="table">
            <table class="table">
            <tr>
