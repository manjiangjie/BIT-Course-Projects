...
// 获取指定日期所在星期的开始时间与结束时间
	...
	public function topJob_show(){
		...
		$data=$job_info->where('company_info.hrId = job_info.hrid and job_info.industryId = industry.industryId')->order('jobClick desc')->limit(10)->select();  //选择排名前100的职位,如果需要还可添加分组
